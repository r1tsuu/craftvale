...
export class ClientEventBus {
  ...
  public on<K extends keyof ServerEventMap>(type: K, handler: ClientEventHandler<K>): () => void {
...
export class ServerEventBus {
  ...
  public on<K extends keyof ClientRequestMap>(type: K, handler: ServerRequestHandler<K>): () => void
  public on<K extends keyof ClientEventMap>(type: K, handler: ServerEventHandler<K>): () => void
  public on(
