import type { ChatEntry, EntityId, PlayerGamemode, PlayerName, PlayerSnapshot } from '../types.ts'
...
import { resolveTimesetPreset, setWorldTimeOfDay } from '../shared/lighting.ts'
import {
...
export class WorldSessionController implements WorldSessionPeer {
  ...
  public async join(
    ...
    const startupChunkCoords = world.getStartupChunkCoords(joinedPlayer.clientPlayer.state.position)
