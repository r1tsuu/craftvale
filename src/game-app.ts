...
export class GameApp {
  ...
  private async tick(): Promise<void> {
    ...
    if (this.state.appMode === "menu") {
      ...
      uiComponents = this.buildPlayUi(input.windowWidth, input.windowHeight);
    }
  ...
  private buildPlayUi(windowWidth: number, windowHeight: number): UiResolvedComponent[] {
    const inventory = this.deps.clientWorldRuntime.inventory;
