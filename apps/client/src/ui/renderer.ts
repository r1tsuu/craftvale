  ...
  public render(
    ...
    for (const component of components) {
      ...
      if (component.kind === 'slider') {
        ...
        const thumbCenterX =
          component.rect.x + Math.round(component.normalizedValue * component.rect.width)
      ...
      text.push(
        this.toTextCommand(component.text, component.rect, component.scale, palette.text, true),
      )
    }
