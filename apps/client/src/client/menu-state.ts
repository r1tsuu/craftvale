...
export type MenuFocusField = 'world-name' | 'world-seed' | 'server-name' | 'server-address' | null
...
export const setMenuWorlds = (state: MenuState, worlds: readonly WorldSummary[]): MenuState => ({
  ...state,
  worlds: [...worlds],
...
const sanitizeSeedInput = (value: string): string => value.replace(/[^0-9\-]/g, '').slice(0, 16)
